...
<Info>
  Tool overrides only add UI elements. To implement the actual tool behavior, you need to create a custom StateNode and add it to the editor's tools. See the [Custom tools](/getting-started/custom-tools) guide.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Custom tools" icon="hammer" href="/getting-started/custom-tools">
